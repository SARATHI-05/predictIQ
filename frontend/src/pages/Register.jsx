...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 1. Direct registration with PredictIQ backend (instant activation & login)
      ...
      // 2. Best-effort Supabase registration in background
      try {
        ...
        console.warn('[Register] Supabase background sync notice:', sbErr);
      }

      // 3. Navigate directly to application
      navigate('/dashboard');
    } catch (err) {
  ...
  return (
    <div className="auth-bg" style={{
      ...
      <div className="glass-card animate-fade-in" style={{
        ...
        {/* PRIMARY SUPABASE GOOGLE SIGN-UP (DIRECT LOG IN) */}
